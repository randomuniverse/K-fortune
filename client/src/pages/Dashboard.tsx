...
import { Loader2, Sparkles, AlertCircle, Send, Sun, CalendarDays, Compass } from "lucide-react";
            ...
            >
              ...
              {!todayFortuneData && !generateFortune.isPending && (
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  className="py-16 text-center glass-panel rounded-xl"
                >
              ...
              {pastFortunes.length > 0 && (
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    {visibleFortunes.map((fortune, idx) => (
