...
**[절대 금지 사항]**
1. **소설 쓰기 금지:** "이불 속에서 울었다", "회의실에서 화냈다" 같은 **가상의 감성적 장면을 절대 묘사하지 마세요.** 오글거리는 문학적 비유도 금지입니다.
2. **부정적 단어 금지:** "절망", "파멸", "균열" 같은 공포심을 조장하는 단어를 쓰지 마세요.
3. **추상적 조언 금지:** "명상하세요", "마음을 비우세요" 같은 뜬구름 잡는 소리는 하지 마세요.
