...
를 알려주세요.`;
  ...
  const generate = async (sys: string, usr: string) => {
  ...
  const [saju1, saju2, saju3, zodiac1, zodiac2, zodiac3, num1, num2, num3] = await Promise.all([
    generate(sajuSystemPrompt, sajuUserPrompt),
    generate(sajuSystemPrompt, sajuUserPrompt),
    generate(sajuSystemPrompt, sajuUserPrompt),
    generate(zodiacSystemPrompt, zodiacUserPrompt),
    generate(zodiacSystemPrompt, zodiacUserPrompt),
    generate(zodiacSystemPrompt, zodiacUserPrompt),
    generate(numerologySystemPrompt, numerologyUserPrompt),
    generate(numerologySystemPrompt, numerologyUserPrompt),
    generate(numerologySystemPrompt, numerologyUserPrompt),
  ]);
